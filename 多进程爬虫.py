import multiprocessing, time, random, requests, re
import pandas as pd
...
def main():
    ...
    p1 = multiprocessing.Process(target=download,args=(urls, headers, q))
    p2 = multiprocessing.Process(target=save, args=(q,))
    p1.start()
    p2.start()
